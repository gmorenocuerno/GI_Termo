 ...
 */
@Embeddable
public class TerEmpleadoPK implements Serializable {
    ...
    public TerEmpleadoPK() {
    }

    public TerEmpleadoPK(int idAreaNegocio, int id) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TerEmpleadoPK)) {
            return false;
        }
        TerEmpleadoPK other = (TerEmpleadoPK) object;
    ...
    public String toString() {
        return "com.gpinfinity.entities.TerEmpleadoPK[ idAreaNegocio=" + idAreaNegocio + ", id=" + id + " ]";
    }
